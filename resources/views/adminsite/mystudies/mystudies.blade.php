...
@section('main-content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0 text-dark">MyStudies Records</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/mystudies">My Studies</a></li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-12" >Name of what i learned: </label>
                                <input type="text" name="nameofstudy" id="nameofstudy" class="form-control" />
                                <span class="invalid-feedback" role="alert">
                                    <strong id="error-nameofstudy"></strong>
                                </span>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#myForm').on('submit', function(event){
                ...
                $('.form-control').removeClass('is-invalid')
                var action_url = "{{ route('mystudies.store') }}";
                var type = "POST";

                if($('#action').val() == 'Edit'){
                    var id = $('#hidden_id').val();
                    action_url = "mystudies/" + id;
                    type = "PUT";
                }
